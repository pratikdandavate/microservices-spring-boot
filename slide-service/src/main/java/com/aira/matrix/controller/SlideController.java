...
public class SlideController {
    ...
    @GetMapping("/slides/organs/{organId}")
    ...
    @PostMapping("/slides/organs/{organId}")
    public Slide createSlide(@PathVariable(value = "organId") Long organId, @Valid @RequestBody Slide slide) {
    ...
    @PutMapping("/slides/{slideId}/organs/{organId}")
    public Slide updateSlide(@PathVariable(value = "organId") Long organId,
            @PathVariable(value = "slideId") Long slideId, @Valid @RequestBody Slide slideRequest) {
    ...
    @DeleteMapping("/slides/{slideId}/organs/{organId}")
    public ResponseEntity<?> deleteSlide(@PathVariable(value = "organId") Long organId,
        ...
        return slideRepository.findByIdAndOrganId(slideId, organId).map(Slide -> {
            ...
            return ResponseEntity.ok().build();
                ...
                () -> new ResourceNotFoundException("Slide not found with id " + slideId + " and organId " + organId));
    }
